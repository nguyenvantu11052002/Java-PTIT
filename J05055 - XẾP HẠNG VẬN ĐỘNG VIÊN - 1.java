...
public class Main {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        for (int i = 0; i < n; i++) {
            ...
            VanDongVien x = new VanDongVien(s1, s2, s3, s4);
            list.add(x);
        ...
        for (VanDongVien x : list) {
            System.out.print(x + " ");
            System.out.println(Support.rank(x.thanhTichDeXepHang(), listThanhTich));
        }
    }
}
...
public class VanDongVien {
    ...
    public VanDongVien(String hoTen, String ngaySinh, String thoiGianXuatPhat, String thoiGianDenDich) throws ParseException {
